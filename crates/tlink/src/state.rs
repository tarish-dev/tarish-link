...
impl DataPathState {
    ...
    ///
    /// **Why this is opt-in.** tlink has been elected master repeatedly while sending a
...
/// describe the radio, so the only correct source for them is the radio — `tlink-hal`,
